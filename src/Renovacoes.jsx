...
const Renovacoes = ({ leads, usuarios, onUpdateStatus, transferirLead, usuarioLogado, fetchLeadsFromSheet, scrollContainerRef }) => {
  ...
  return (
    <div style={{ padding: '20px', position: 'relative', minHeight: 'calc(100vh - 100px)' }}>
      ...
      {/* Cabeçalho, Título e Botão de Refresh */}
      <div
        style={{
          display: 'flex',
        ...
        {hasScheduledToday && (
          <div
            style={{
              ...
              justifyContent: 'center',
              alignItems: 'center',
              minWidth: '50px', // Para garantir espaço mínimo no flex-wrap
            }}
          >
            <div
              style={{
          ...
          {leadsPagina.map((lead) => {
            ...
            return (
              ...
              >
                ...
                {/* Observações e Ações (Lado Direito) */}
                ...
                {/* Atribuição de Usuário (Abaixo, largura total) */}
                <div style={{ width: '100%', marginTop: '15px' }}>
                  {lead.responsavel && responsavel ? (
                    ...
                    >
                      <label htmlFor={`select-user-${lead.id}`} style={{ fontWeight: 'bold', color: '#555', margin: 0 }}>
                        Atribuir Lead:
                      </label>
                      <select
